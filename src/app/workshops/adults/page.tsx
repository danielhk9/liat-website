...
export const metadata = {
  title: "סדנאת מבוגרים | לחשוב בריא",
};
...
export default function Adults() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-20">
      ...
      <h1 className="text-3xl md:text-4xl font-extrabold text-green-600 mb-4">סדנאת מבוגרים</h1>
      <p className="text-gray-600 text-lg mb-8 leading-relaxed">
        סדנאה למבוגרים — הורים, סבתות וסבות — שרוצים ללמוד כיצד להכין אוכל בריא לילדים
        ולשנות את הגישה לתזונה נכונה. תלמדו כיצד לחשוב בריא, לבשל בריא ולהנות מהדרך.
      </p>

      <ul className="space-y-3 mb-10 text-gray-700">
        {["מתאים להורים וטיפולי ילדים", "קבוצות עד 15 משתתפים", "משך הסדנה: שלוש שעות", "כולל חומרי גלם, מתכונים וחוברת"].map((item) => (
      ...
      >
        ...
        <CalBooking calLink="Liat_Leibovich/adults" namespace="adults" />
      </div>
    </div>
  );
}
