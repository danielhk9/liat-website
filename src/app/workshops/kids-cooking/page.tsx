...
export const metadata = {
  title: "סדנאת בישול לילדים | לחשוב בריא",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-20">
      ...
      <p className="text-gray-600 text-lg mb-8 leading-relaxed">
        ...
        הכל דרך חוויה ידנית ומשמחת.
      </p>

      <ul className="space-y-3 mb-10 text-gray-700">
        {["מתאים לגילאי 5–12", "קבוצות קטנות עד 12 ילדים", "משך הסדנה: כשעתיים", "כולל חומרי גלם וציוד"].map((item) => (
      ...
      >
        ...
        <CalBooking calLink="Liat_Leibovich/kids-cooking" namespace="kids-cooking" />
      </div>
    </div>
  );
}
